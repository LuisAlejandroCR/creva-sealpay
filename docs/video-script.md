...
| Precio | No hay precio — el ask son las pistas de premio: Hedera ($6k, entregado) + World ($3.5k) + ENS ($500, entregado) + Arc ($10k, entregado) + Bazantic ($3k, entregado) + Uniswap Foundation ($5k) |
...
| 1:45–2:05 | **Honestidad sobre lo que falta** | *"Lo que no hemos cerrado todavía: Selfie Check contra el sandbox real de World — el enrollment está pendiente de aprobación de Tools for Humanity, no es trabajo nuestro sin hacer."* (Mostrar el hash de la tx real de Hedera, el anclaje real en Arc y el reporte real generado vía Bazantic como prueba de lo que sí cerró.) |
| 2:05–2:30 | **El ask** | *"Aplicamos a Hedera AI & Agentic Payments, World Selfie Check, ENS, Arc de Circle, Bazantic y Uniswap Foundation, dentro de la pista Continuity. Les pedimos avanzar como finalistas — lo que ya corre es la prueba de que el resto se cierra."* |
