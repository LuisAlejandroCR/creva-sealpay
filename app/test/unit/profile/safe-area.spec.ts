// safe-area.spec.ts: ProfileScreen must clear the OS status bar, same convention as
// QueryScreen/VerifyScreen/DashboardScreen — SafeAreaView with a top edge wrapping the content.
import { readFileSync } from 'fs'
import { join } from 'path'

const source = readFileSync(join(__dirname, '../../../features/profile/ProfileScreen.tsx'), 'utf-8')

describe('ProfileScreen safe-area insets', () => {
